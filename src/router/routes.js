    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'report',
            component: () => import('pages/Dashboard/Farmer/Report.vue')
          }
        ]
      },
      {
      ...
      {
        path: 'schemes',
        component: () => import('layouts/Dashboard/Scheme.vue'),
        children: [
          {
            path: '',
            component: () => import('pages/Schemes/Index.vue')
          }
        ]
      },
      {
      ...
      {
        path: 'retina/trainer',
        component: () => import('pages/Retina/Trainer.vue')
      },
      {
        path: 'retina/trainer/auto',
        component: () => import('pages/Retina/TrainerAuto.vue')
      },
      ...
      },
      {
        ...
        children: [
          {
            path: 'Index',
            component: () => import('pages/FertilizerCalci/Index.vue')
          }
        ],
        component: () => import('layouts/FertilizerCalci.vue')
      },
      ...
      {
        path: 'profile/setup',
        component: () => import('pages/Profile/Setup.vue')
      },
      {
        path: 'about',
