...
<q-page padding class="flex flex-center my-bg ">
    ...
    <div class="row justify-center flex-block full-width">
        <q-card class="col-12 col-md-3 col-sm-6 box-shadow">
            ...
            <q-card-section>
                <q-input color="teal" filled v-model="username" placeholder="Username" input-class="text-left" class="q-mb-md" type="text">
                    <template v-slot:prepend>
                        <q-icon style="margin-right:25px" name="person" />
                    </template>
                </q-input>
                <q-input color="teal" filled v-model="password" placeholder="Password" input-class="text-left" class="q-mb-md" type="password" float-label="Password">
                    <template v-slot:prepend>
                        <q-icon style="margin-right:25px" name="lock" />
                    </template>
                </q-input>

                <q-btn rounded dense size="18px" color="primary" label="Log in" class="full-width" style="margin-top:12px" @click="login" />

                <div class=" text register text-grey ">New to Flora?
